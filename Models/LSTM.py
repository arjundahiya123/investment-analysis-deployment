...
# predicted_prices = np.repeat(predictions, 5, axis=1)
...
predicted_next_close = predicted_next_close.flatten()
predicted_next_close = predicted_next_close.reshape(-1, 1)
# Inverse transform the predicted value to the original scale
predicted_next_close_original_scale = scaler.inverse_transform(predicted_next_close)
